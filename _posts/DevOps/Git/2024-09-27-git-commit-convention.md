---
title: "[Git] 커밋 컨벤션 (Commit Convention)"
excerpt: "프로젝트 참여자들이 일관된 형식의 커밋 메시지를 작성하기 위한 규칙을 말하며, Git Commit Convention 이라고 합니다. 현재 여러 개발자들 사이에서 관습적으로 통용되는 가이드라인이 있지만, 각 프로젝트에 따라서 별도의 규칙을 만들어 적용하기도 합니다."
