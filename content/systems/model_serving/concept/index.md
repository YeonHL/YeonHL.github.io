...
가장 인상 깊었던 내용은 기존 소프트웨어와의 차이점입니다. 분명 다름을 인지하고 있었지만, 이를 설명하는 것이 어려웠는데, 모델의 정확성은 확률론적 특성을 갖는다는 내용을 보며 공감했습니다. 또한 이로 인해 발생하는 드리프트의 개념 및 대응 방향을 인지할 수 있었습니다.

이후의 포스트에서는 아직 다루지 않은 구체적인 내용들을 살펴보겠습니다. 세부 이론이나 모델 서빙 시스템을 구축하기 위한 아키텍처, 기술적인 목표 등을 알아보겠습니다.
